...
class Bank8FMDataReader(BaseDataReader):
    def __init__(self,
                 params):
        super(Bank8FMDataReader, self).__init__(params=params)
        self.device = params.device
        self.data_path = f"{MAIN_DIR}/Data/old_data/Bank8FM/bank8FM.data"
        self.test_data_path = f"{MAIN_DIR}/Data/old_data/Bank8FM/bank8FM.test"
        self.data_full_path = f"{MAIN_DIR}/Data/old_data/Bank8FM/bank8fm.txt"
        self.label_index = 8
        self.n_step = 0#params.n_step
        self.require_presence_pattern = False
        # self.raw = torch.from_numpy(np.genfromtxt(self.data_path))
        ...
        if self.is_normalize:
            ...
            # self.raw_test = (self.raw_test - (a + b) / 2) * 2 / (b - a)
        ...
        self.train_length = 4499#round((self.raw.shape[0]*self.train_ratio))
...
if __name__ == "__main__":
    params = Namespace(**{"train_ratio": 0.6,
                          ...
                          "is_batch": False,
                          "is_normalize":True})
    reader = Bank8FMDataReader(params=params)
