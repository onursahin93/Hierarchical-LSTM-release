...
class CompactivDataReader(BaseDataReader):
    def __init__(self,
                 params):
        super(CompactivDataReader, self).__init__(params=params)
        self.device = params.device
        self.data_path = f"{MAIN_DIR}/Data/old_data/Compactiv/compactiv.dat"
...
if __name__ == "__main__":
    params = Namespace(**{"train_ratio": 0.6,
                          ...
                          "is_batch": False,
                          "is_normalize":True})
    reader = CompactivDataReader(params=params)
