...
class AbaloneDataReader(BaseDataReader):
    def __init__(self,
                 params):
        super(AbaloneDataReader, self).__init__(params=params)
        self.device = params.device
        self.data_path = f"{MAIN_DIR}/Data/old_data/Abalone/abalone.data"
...
if __name__ == "__main__":
    params = Namespace(**{"train_ratio": 0.6,
                          ...
                          "is_batch": False,
                          "is_normalize":True})
    reader = AbaloneDataReader(params=params)
