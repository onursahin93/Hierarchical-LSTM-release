...
class HouseDataReader(BaseDataReader):
    def __init__(self,
                 params):
        super(HouseDataReader, self).__init__(params=params)
        self.device = params.device
        self.data_path = f"{MAIN_DIR}/Data/old_data/House/house.dat"
...
if __name__ == "__main__":
    params = Namespace(**{"train_ratio": 0.6,
                          ...
                          "window_length": 3})
    reader = HouseDataReader(params=params)
