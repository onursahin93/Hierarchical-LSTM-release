...
class HkeDataReader(BaseDataReader):
    def __init__(self,
                 params):
        super(HkeDataReader, self).__init__(params=params)
        self.device = params.device
        self.data_path = f"{MAIN_DIR}/Data/old_data/Hke/data_hke.mat"
        self.label_path = f"{MAIN_DIR}/Data/old_data/Hke/label_hke.mat"
...
if __name__ == "__main__":
    params = Namespace(**{"train_ratio": 0.6,
                          ...
                          "is_batch": False,
                          "is_normalize":True})
    reader = HkeDataReader(params=params)
