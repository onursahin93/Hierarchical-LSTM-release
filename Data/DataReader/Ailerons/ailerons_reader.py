...
class AileronsDataReader(BaseDataReader):
    def __init__(self,
                 params):
        super(AileronsDataReader, self).__init__(params=params)
        self.device = params.device
        self.data_path = f"{MAIN_DIR}/Data/old_data/Ailerons/ailerons.dat"
        self.label_index = 40
...
if __name__ == "__main__":
    params = Namespace(**{"train_ratio": 0.6,
                          ...
                          "is_batch": False,
                          "is_normalize": True})
    reader = AileronsDataReader(params=params)
