...
class PumadynDataReader(BaseDataReader):
    def __init__(self,
                 params):
        super(PumadynDataReader, self).__init__(params=params)
        self.device = params.device
        self.data_path = f"{MAIN_DIR}/Data/old_data/Pumadyn/puma32h.dat"
        self.label_index = 32
...
if __name__ == "__main__":
    params = Namespace(**{"train_ratio": 0.6,
                          ...
                          "is_batch": False,
                          "is_normalize":True})
    reader = PumadynDataReader(params=params)
