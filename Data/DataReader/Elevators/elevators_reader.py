...
class ElevatorsDataReader(BaseDataReader):
    def __init__(self,
                 params):
        super(ElevatorsDataReader, self).__init__(params=params)
        self.device = params.device
        self.data_path = f"{MAIN_DIR}/Data/old_data/Elevators/elevators.dat"
...
if __name__ == "__main__":
    params = Namespace(**{"train_ratio": 0.6,
                          ...
                          "is_batch": False,
                          "is_normalize":True})
    reader = ElevatorsDataReader(params=params)
