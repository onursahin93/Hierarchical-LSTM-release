...
class AutoMPGDataReader(BaseDataReader):
    def __init__(self,
                 params):
        super(AutoMPGDataReader, self).__init__(params=params)
        raise NotImplementedError
        self.device = params.device
        self.data_path = f"{MAIN_DIR}/Data/old_data/Auto MPG/auto.data"
...
if __name__ == "__main__":
    params = Namespace(**{"train_ratio": 0.6,
                          ...
                          "is_batch": False,
                          "is_normalize":True})
    reader = AutoMPGDataReader(params=params)
