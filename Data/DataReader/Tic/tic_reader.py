...
class TicDataReader(BaseDataReader):
    def __init__(self,
                 params):
        super(TicDataReader, self).__init__(params=params)
        self.device = params.device
        self.data_path = f"{MAIN_DIR}/Data/old_data/Tic/tic.dat"
...
if __name__ == "__main__":
    params = Namespace(**{"train_ratio": 0.6,
                          ...
                          "window_length": 3})
    reader = TicDataReader(params=params)
